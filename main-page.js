...
var stackModule = require("ui/list-view");
...
function navigateToTasks(args) {
    FrameModule.topmost().navigate({moduleName: "Recorder", context: {list_name: args.object.bindingContext.lists.getItem(args.index).list_name}});
}
