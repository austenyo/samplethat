...
function createViewModel(database, listname) {
    var viewModel = new Observable();
    viewModel.files = new ObservableArray([]);
    viewModel.listname = listname;
    console.log("here")
    Dialogs.prompt("looking for files", "").then(result => {
        database.execSQL("INSERT INTO tasks (list_id, task_name) VALUES (?, ?)", [this.listname, result.text]).then(id => {
